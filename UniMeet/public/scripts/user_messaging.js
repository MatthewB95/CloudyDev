...
function getCurrentUser(docRef) {
	...
	docRef.get().then(function (doc) {
		if (doc && doc.exists) {
			...
			currentUserImage = student.profile_image;
...
function loadMessages() {
	...
	var uids = [selectedProfileID, currentUserID].sort();
...
function displayMessage(key, name, text, picUrl, imageUrl) {
	...
	sender.setAttribute('class', 'messageName');
		sender.innerHTML = name;
	container.appendChild(sender);
	
	var messageBubble = document.createElement('div');
	messageBubble.setAttribute('class', 'messageInlineBlock');
	
		var message = document.createElement('div');
	message.setAttribute('class', 'messageBubble');
		message.innerHTML = text;
	messageBubble.appendChild(message);
	
		var imageIcon = document.createElement('img');
	imageIcon.setAttribute('class', 'messageImageIcon');
		imageIcon.src = picUrl;
